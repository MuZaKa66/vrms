...
class MainWindow(QMainWindow):
    ...
    def create_top_status_bar(self):
        ...
        """)
        exit_btn.clicked.connect(self.handle_exit_request)
    ...
    def handle_exit_request(self):
        """Handle exit with recording protection (voice-independent)."""
        if self.recording_screen.controller.state == RecordingState.RECORDING:
            QMessageBox.warning(
                self, 
                "Recording in Progress", 
                "Cannot close while recording!\n\n"
        ...
        if reply == QMessageBox.Yes:
            ...
            if self.voice_service and self.voice_enabled:
                try:
                    ...
                    pass  # Ignore voice cleanup errors
